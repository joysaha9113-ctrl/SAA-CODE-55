...
int main() {
    ...
    int passengers = 0;  // current passengers inside tram
    ...
    for (int i = 0; i < n; i++) {
        ...
        passengers -= exit;   // first passengers exit
        passengers += enter;  // then passengers enter

        maxCapacity = max(maxCapacity, passengers); // track max passengers
    }
